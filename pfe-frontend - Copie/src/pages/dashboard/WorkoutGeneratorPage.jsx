                ...
                <button
                  ...
                  className={`p-3 rounded-xl text-sm font-medium transition-all duration-200 border ${
                    goal === g.id
                      ...
                      : 'bg-white dark:bg-surface-800/40 border-[#E2E8F0] dark:border-surface-700/30 text-surface-500 dark:text-surface-400 hover:border-[#CBD5E1] dark:hover:border-surface-600'
                  }`}
                >
            ...
            {[1,2,3].map(i => (
              <div key={i} className="glass-card p-5 animate-pulse">
                ...
                <div className="space-y-2 mb-4">
                  {[1,2,3].map(j => <div key={j} className="h-3 bg-[#E2E8F0] dark:bg-surface-700/30 rounded w-full" />)}
                </div>
        ...
        {generated && !loading && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {generated.map((w, i) => (
                <WorkoutCard key={w.id} workout={w} index={i} onSelect={() => window.location.href = '/dashboard/training'} />
              ))}
            </div>
          </motion.div>
        )}
